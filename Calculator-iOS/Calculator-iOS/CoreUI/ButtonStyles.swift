...
class ButtonStyles {
    ...
    static let operatorButton = ReusableCommonButton(fontName: "Poppins",
                                                     fontSize: 32,
    ...
    static let digitButton = ReusableCommonButton(fontName: "Poppins",
                                                  fontSize: 32,
    ...
    static let equalButton = ReusableCommonButton(fontName: "Poppins",
                                                  fontSize: 32,
                                                  colorText: .white,
                                                  cornerRadius: 12,
                                                  borderWidght: 1.2,
