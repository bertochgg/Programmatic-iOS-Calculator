...
protocol ReusableNormalButton {
    func setupButton(with key: String, color: UIColor)
}

extension ReusableNormalButton where Self: UIButton {
    func setupButton(with key: String, color: UIColor) {
        // Font configuration
...
class NormalButton: UIButton, ReusableNormalButton {}
